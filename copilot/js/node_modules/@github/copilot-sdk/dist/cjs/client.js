...
var import_runtimeArtifacts = require("./runtimeArtifacts.js");
...
function getBundledRuntimePath() {
  return (0, import_runtimeArtifacts.ensureRuntimeBundle)(import_cliVersion.COPILOT_CLI_VERSION);
}
...
`);
  ...
  parseCliUrl(url) {
    ...
    if (ipv6Match) {
      ...
      if (!(0, import_node_net.isIPv6)(host2)) {
  ...
  registerGitHubTokenProvider(provider, sessionId) {
    ...
    const registrationId = (0, import_node_crypto.randomUUID)();
...
stderr: ${stderrOutput}`
  ...
  async startInProcessFfi() {
    ...
    if (explicitEntrypoint) {
      const entrypointDirectory = (0, import_node_path.dirname)((0, import_node_path.resolve)(explicitEntrypoint));
      const adjacentRuntime = (0, import_node_path.join)(entrypointDirectory, "runtime.node");
      runtimeLibrary = (0, import_node_fs.existsSync)(adjacentRuntime) ? adjacentRuntime : (0, import_node_path.join)(
        entrypointDirectory,
        "prebuilds",
      ...
      runtimeLibrary = (0, import_node_path.join)((0, import_node_path.dirname)(await getBundledRuntimePath()), "runtime.node");
    }
